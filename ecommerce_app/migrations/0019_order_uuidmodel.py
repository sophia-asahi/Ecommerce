# Generated by Django 3.2.5 on 2022-05-16 08:56
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ecommerce_app', '0018_delete_order'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Order',
            fields=[
                ('uuidmodel_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='ecommerce_app.uuidmodel')),
